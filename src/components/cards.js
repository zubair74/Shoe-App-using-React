...
export default function Cards({ shoes, shoeData, addCart, findShoe }) {
  ...
  //           <div>
  //           <h4 className = 'shoe-name'>{url.name}</h4>
  //           <h6>{url.type}</h6>
  ...
  //           </div>
  //           </div>
  //           <Button variant="contained" color="secondary" value = 'blue' className = 'my-button' onClick = {(e) => addCart(e.target.value)}>
  //   ADD TO CART
  // </Button>
  //         </Typography>
  //       </CardContent>
